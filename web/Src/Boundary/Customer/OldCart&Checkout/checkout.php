...
require_once 'processOrder.php'; // For database insertion
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // If no errors, process using processOrder.php
    if (empty($errors)) {
        try {
            ...
            $orderId = $orderProcessor->createOrder($customerData, $cartItems, $totals);
...
<div class="checkout-container">
    <div class="checkout-form">
        <a href="viewCart.php" class="btn-back">← Back to Cart</a>
